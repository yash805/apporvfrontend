...
import { clearSelectedProducts, createProductAsync, fetchProductsByIdAsync, selectBrands, selectCategories, selectProductById, updateProductAsync } from '../../product/ProductSlice';
...
const ProductForm = () => {
  ...
  useEffect(()=>{
    ...
    setValue('discountPercentage', selectedProduct.description)
