...
const Checkout = () => {
    ...
    const totalAmount = items.reduce((acc, item) => discountedPrice(item.product) * item.quantity + acc, 0)
            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
                    <div className="lg:col-span-3">
                        <form className="bg-white py-12 px-5 mt-12" noValidate
                    ...
                    <div className="lg:col-span-2">
                        <div className='mx-auto mt-12 nax-w-7xl px-2 sm:px-2 lg:px-4'>
